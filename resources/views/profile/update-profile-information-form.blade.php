    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
         ...
         <div class="col-span-6 sm:col-span-4">
            ...
            <x-input id="bio data" type="text" class="mt-1 block w-full" wire:model.defer="state.biodata" autocomplete="biodata" />
            <x-input-error for="bio" class="mt-2" />
        </div>
        <!-- Experience -->
        <div class="col-span-6 sm:col-span-4">
            <x-label for="experience" value="{{ __('experience') }}" />
            <x-input id="experience" type="text" class="mt-1 block w-full" wire:model.defer="state.experience" autocomplete="experience" />
